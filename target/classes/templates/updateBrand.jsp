...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:th="http://www.thymeleaf.org">
    ...
    <body>
        ...
        <div class="container text-center">
			...
			<div class="panel-heading" style = "text-align:left;">UPDATE Brand</div>
			<div class="panel-body">
	        <form class="form-horizontal" method="POST" th:action="@{/updateBrand}" th:object="${brandMaster}">
				...
				<div class="form-group">
					...
					<div class="col-md-7">
						<input type="text" class="form-control" name="percentage" th:field="*{percentage}" onkeypress='return validate(event)' required/>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3"><font color="red">Rate/Case</font></label>
					<div class="col-md-7">
						<input type="text" class="form-control" name="amount" th:field="*{amount}" onkeypress=' return validate(event)' required/>
					</div>
				</div>
				<div class="form-group ">
